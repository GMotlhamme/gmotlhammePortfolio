...
function ContactMe() {
    return (
        ...
        <section
            id="contact"
            className='bg-zinc-500 flex flex-col items-center dark:bg-zinc-900 rounded-lg p-8 lg:row-1 md:row-1 min-h-150 h-full w-full'
          >
            
            <p className="animate-fadeIn4 dark:text-white opacity-70 text-4xl lg:text-8xl font-semibold">CONTACT ME</p>
<section className="flex flex-col lg:flex-row justify-center lg:gap-4 pt-14">
